...
public class CharacterStatModifier : MonoBehaviour
{
	...
	{
		transform.localScale = Vector3.one * 1.2f * Mathf.Pow(100 / 100f * 1.2f, 0.2f) * sizeMultiplier;
		data.playerVel.rb.mass = 100f * Mathf.Pow(100 / 100f * 1.2f, 0.8f) * sizeMultiplier;
	}
}
